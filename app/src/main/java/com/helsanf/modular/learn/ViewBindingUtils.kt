...
class ViewBindingUtils<T : ViewBinding>(
    private val fragment: Fragment,
    bindingClass: Class<T>
) : ReadOnlyProperty<Fragment, T> {

    private var binding: T? = null
    private val bindingMethod = bindingClass.getMethod(BindingObject.bindMethod, View::class.java)
...
class ActivityViewBindingUtils <T : ViewBinding>(
...
object BindingObject{
    const val bindMethod = "bind"
    const val inflateMethod = "inflate"

    inline fun <reified T : ViewBinding> Fragment.viewBinding() =
        ViewBindingUtils(this, T::class.java)

    inline fun <reified T : ViewBinding> Activity.viewBinding() =
        ActivityViewBindingUtils(T::class.java)
}